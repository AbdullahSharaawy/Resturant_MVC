...
namespace Resturant_BLL.Services
{
    public interface IOrderService
    {
        ...
        public Task<List<AdminOrderDTO>?> FilterBy(Expression<Func<Orders, bool>> filter);
        ...
        public Task<List<ReadOrderDTO>?> FilterMyOrdersBy(Expression<Func<Orders, bool>> filter);
    }
}
